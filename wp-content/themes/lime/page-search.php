          ...
          <main id="main" class="site-main mt-5" role="main">
                    <aquila-search class="aquila-search row px-4">
                              <aquila-filters class="col-lg-3 col-md-3 col-sm-12 pb-4">
                                        <aquila-clear-all-filters class="clear-all-filters">
                                                  <button class="btn btn-secondary">Clear All filters</button>
                                        </aquila-clear-all-filters>
                                                                      ...
                                                                      <?php foreach ($filter_data['children'] as $item): ?>
                                                                                ...
                                                                                <?php if (!empty($item['label'])): ?>
                                                                                          <aquila-checkbox-accordion-child
                                                                                                    ...
                                                                                                    <div
                                                                                                              class="checkbox-accordion__child-handle form-field">
                                                                                                              <label data-text="<?php echo esc_attr($item['label']); ?>"
                                                                                                                        class="checkbox">
                                                                                                              ...
                                                                                                              <div class="checkbox-accordion__child-content">
                                                                                                                        <?php foreach ($item['children'] as $child): ?>
                                                                                                                                  ...
                                                                                                                                  <?php if (!empty($child['label']) && !empty($child['value'])): ?>
                                                                                                                                            <aquila-checkbox-accordion-child
                                                                                                                                                      class="checkbox-accordion__child">
                                                                                                                                                      <div
                                                                                                                                                                class="checkbox-accordion__child-handle form-field">
                                                                                                                                                      ...
                                                                                                                                                      <?php if (!empty($has_grand_children)): ?>
                                                                                                                                                                <div
                                                                                                                                                                          class="checkbox-accordion__child-content">
                                                                                                                                                                                                                            ...
                                                                                                                                                                                                                            <?php foreach ($grand_children['children'] as $great_grand_children): ?>
                                                                                                                                                                                                                                      <?php if (!empty($great_grand_children['label']) && !empty($great_grand_children['value'])): ?>
                                                                                                                                                                                                                                                <div
                                                                                                                                                                                                                                                          ...
                                                                                                                                                                                                                                                          <label data-text="<?php echo esc_attr($great_grand_children['label']); ?>"
                                                                                                                                                                                                                                                                    class="checkbox">
                                                                                                                                                                                                                                                                    <input data-key="<?php echo esc_attr($filter_data['slug'] ?? ''); ?>"
                                                                                                                                                                                                                                                                    ...
                                                                                                                                                                                                                                                                    <span data-text="<?php echo esc_attr($great_grand_children['label']); ?>"
